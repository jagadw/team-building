...
const Teams = () => {
  ...
  const [teams, setTeams] = useState<Team[]>([
    ...
    { id: 2, name: 'Team Bravo', slug: 'team-bravo', event: 'Event A' },
    { id: 3, name: 'Team Charlie', slug: 'team-charlie', event: 'Event B' },
  ]);
        ...
        <tbody>
          {teams.map((team, index) => (
            <tr key={team.id} className="border-t border-gray-200">
              ...
              <td className="p-2">{team.event}</td>
